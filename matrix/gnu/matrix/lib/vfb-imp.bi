#inclib "vfb-ops"
' Pi round Error Scream Sys
Declare Function PiRoundError (ByRef RoundError As EventArgs)
type RoundError
   Dim RoundErrorTypes As CheckBoxState
   Dim RoundErrorEvent As CheckBoxState
   Dim RoundErrorObjes As CheckBoxState
end type
